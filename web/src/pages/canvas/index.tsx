...
export default function CanvasPage() {
    ...
    const createAndEnter = () => enterProject(createProject(`视频生成站 ${projects.length + 1}`));
    ...
    useEffect(() => {
        ...
        enterProject(mode === "new" ? createProject(`视频生成站 ${projects.length + 1}`) : projects[0]?.id || createProject(`视频生成站 ${projects.length + 1}`));
