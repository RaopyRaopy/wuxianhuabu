            ...
            <main className="relative z-10 min-h-0 flex-1 overflow-y-auto bg-background/70 px-6 py-8 backdrop-blur-[1px]">
                <div className="pb-8">
                    ...
                    <div className="mx-auto mt-6 grid max-w-6xl gap-3 text-left">
                        <div className="specular-frame flex flex-col gap-3 rounded-xl border p-4 sm:flex-row sm:items-center sm:justify-between">
...
function AssetCard({ asset, onOpen, onEdit, onCopy, onDownload, onDelete }: { asset: Asset; onOpen: () => void; onEdit: () => void; onCopy: (asset: Asset) => void; onDownload: (asset: Asset) => void; onDelete: () => void }) {
    ...
    return (
        <Card
            hoverable
            className="specular-frame overflow-hidden"
